...
def terminate_if_direct_outward(direction, normal):
    if np.dot(direction, normal) > 0:  # Direction is outward, reverse it
...
def simulate_bounce(p1, grad_S1, p2, grad_S2, iterations=1):
    ...
    normal_S2 = compute_normal_to_superellipse(None, grad_S2, p2) #
    ...
    for iter in range(1, iterations+1):
        ...
        # 从p1射线反弹
        dir2 = -normal_S2
        if terminate_if_direct_outward(dir2, normal_S1):
            print("end. terminate_if_direct_outward(dir2, normal_S1)")
            break
        ...
        print("normal S1: ", normal_S1)
        points_S1.append(n1)

        # 对 p2 计算反弹
        # Reversing direction if it is outward
        dir1 = normal_S1
        if terminate_if_direct_outward(dir1, normal_S2):
            print("end terminate_if_direct_outward(dir1, normal_S2)")
            break    
